...
import com.example.iismobile.preferences.adapters.PreferencesAdapter
...
class PreferencesFragment : ModelDataFragment<PreferencesFragment.PreferencesViewState, ProfilePreferences>(R.layout.f_preferences) {
    ...
    private fun ProfilePreferences.asAccessEntries(): List<PreferenceEntry> =
        listOf(
            PreferenceEntry(
                PreferenceType.RATING, R.string.access_preference_rating, R.drawable.ic_round_visibility_24,
                R.drawable.ic_round_visibility_off_24, showRating, R.string.show_title, R.string.dont_show_title),
            PreferenceEntry(
                PreferenceType.PUBLISHED, R.string.access_preference_profile, R.drawable.ic_round_visibility_24,
                R.drawable.ic_round_visibility_off_24, published, R.string.show_title, R.string.dont_show_title),
            PreferenceEntry(
                PreferenceType.SEARCH_JOB, R.string.access_preference_job, R.drawable.ic_round_work_24,
